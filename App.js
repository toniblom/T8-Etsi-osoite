...
export default function App() {
  ...
  // Get current location when app opened
  useEffect(() => {
    (async () => {
      ...
      setRegion({ latitude: location.coords.latitude, longitude: location.coords.longitude, latitudeDelta: latitudeDelta, longitudeDelta: longitudeDelta });
...
// TEHTÄVÄN 8 RATKAISU ILMAN TEHTÄVÄN 10 LISÄYKSIÄ
/* import React, { useState, useEffect } from 'react';
import { StyleSheet, StatusBar, View, TextInput, Button, Alert } from 'react-native';
import MapView, { Marker } from 'react-native-maps';
